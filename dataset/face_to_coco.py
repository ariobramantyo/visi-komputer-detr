...
phases = ["train", "val"]
dir_path = 'd:/Telkom University/Semester 7/Visi Komputer/Tubes/detr_tutorial-master/detr_tutorial-master/dataset'
for phase in phases:
    root_path = "{}/WIDER_{}/images/".format(dir_path, phase)
    gt_path = os.path.join("{}/wider_face_split/wider_face_{}.mat".format(dir_path, phase))
